    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-sm border-b border-slate-200/80">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3">
            <Link
              href={ctaHref}
              className="text-slate-500 hover:text-slate-700 hover:bg-slate-100 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200"
            >
              Login
            </Link>
            <Link
              href={ctaHref}
              className="bg-blue-500 text-white hover:bg-blue-600 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm"
            >
              Start Free
            </Link>
          </nav>
      ...
      <section className="bg-white pt-20 pb-8 px-6 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 text-sm font-medium px-3 py-1 rounded-full mb-8 border border-blue-100">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href={ctaHref}
              className="w-full sm:w-auto bg-blue-500 text-white hover:bg-blue-600 px-8 py-3 rounded-lg text-lg font-medium transition-all duration-200 shadow-sm"
            >
              Start Free
            </Link>
            <a
              href="#how-it-works"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-slate-200 text-slate-600 hover:text-slate-800 hover:border-slate-300 hover:bg-slate-50 px-8 py-3 rounded-lg text-lg font-medium transition-all duration-200"
            >
        ...
        <div className="mt-16 max-w-4xl mx-auto px-0 md:px-4">
          ...
          <div className="[transform:perspective(1400px)_rotateX(5deg)] hover:[transform:perspective(1400px)_rotateX(2deg)] transition-all duration-500 [will-change:transform]">
            <div className="rounded-xl overflow-hidden border border-slate-200 shadow-2xl shadow-slate-300/40 bg-white">
              ...
              <div className="bg-slate-100 border-b border-slate-200 px-4 py-3 flex items-center gap-3">
                ...
                <div className="flex-1 bg-white rounded-md border border-slate-200 h-6 flex items-center px-3 gap-2 min-w-0">
              ...
              <div className="flex h-72 select-none">
                ...
                {/* Sidebar */}
                <div className="w-40 bg-white border-r border-slate-100 p-4 shrink-0 flex flex-col gap-1.5">
                  {/* Logo skeleton */}
                  <div className="h-5 w-24 bg-slate-800 rounded mb-3" />
                  {/* Active nav item */}
                  <div className="h-7 w-full bg-blue-50 rounded-md flex items-center px-2.5 gap-2">
                  ...
                  {SIDEBAR_WIDTHS.map((w, i) => (
                    <div key={i} className="h-7 w-full rounded-md flex items-center px-2.5 gap-2">
                      ...
                      <div className={`h-1.5 ${w} bg-slate-200 rounded-full`} />
                    </div>
                  ))}
                </div>

                {/* Main content */}
                <div className="flex-1 bg-slate-50 p-5 flex flex-col gap-3 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="h-7 w-24 bg-blue-500 rounded-md shrink-0" />
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-2.5">
                    <div className="bg-green-50 border border-green-100 rounded-lg p-2.5 space-y-1.5">
                      ...
                      <div className="h-4 w-9 bg-slate-700 rounded" />
                      <div className="h-1.5 w-7 bg-green-400 rounded-full" />
                    </div>
                    <div className="bg-white border border-slate-200 rounded-lg p-2.5 space-y-1.5">
                      ...
                      <div className="h-1.5 w-6 bg-green-400 rounded-full" />
                    </div>
                    <div className="bg-white border border-slate-200 rounded-lg p-2.5 space-y-1.5">
                      <div className="h-1.5 w-12 bg-slate-300 rounded-full" />
                      <div className="h-4 w-8 bg-slate-700 rounded" />
                      <div className="h-1.5 w-9 bg-slate-300 rounded-full" />
                    </div>
                  ...
                  {/* Chart card */}
                  <div className="flex-1 bg-white border border-slate-200 rounded-lg p-3 min-h-0">
                    <div className="flex items-center justify-between mb-2.5">
                      <div className="h-2 w-24 bg-slate-200 rounded-full" />
                      <div className="flex gap-3">
                        <div className="h-1.5 w-16 bg-blue-300 rounded-full" />
      ...
      <section id="how-it-works" className="py-20 bg-slate-50 border-y border-slate-200 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
            ...
            <div className="hidden md:block absolute top-[1.4rem] left-[18%] right-[18%] h-px bg-gradient-to-r from-transparent via-blue-200 to-transparent" />

            {/* Step 1 */}
            <div className="relative text-center">
              {/* Decorative number — behind everything */}
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-7xl font-bold text-slate-100 select-none leading-none pointer-events-none">
                01
              </span>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-sm mx-auto">
          ...
          <div className="relative bg-white border border-slate-200 rounded-xl shadow-sm ring-1 ring-blue-100 p-8 overflow-hidden">
            ...
            <p className="text-base font-semibold text-slate-800 mb-1">Pro Plan</p>

            <div className="flex items-end gap-1 mt-4 mb-7">
              <span className="text-5xl font-bold text-slate-800">$19</span>
              <span className="text-lg text-slate-500 mb-2">/month</span>
            </div>
            ...
            <Link
              href={ctaHref}
              className="block w-full bg-blue-500 text-white hover:bg-blue-600 px-6 py-2.5 rounded-lg font-medium transition-all duration-200 text-center"
            >
              Start Free
            </Link>
      ...
      <footer className="bg-white border-t border-slate-200 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            ...
            className="text-sm text-slate-500 hover:text-slate-700 transition-all duration-200"
          >
