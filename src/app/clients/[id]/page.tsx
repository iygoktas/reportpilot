      ...
      <div className="mt-4 mb-6">
        ...
        {client.website_url ? (
          <a
            ...
            className="inline-flex items-center gap-1.5 text-sm text-blue-500 hover:text-blue-600 mt-1 transition-colors"
          >
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-6 mb-4">
        ...
        <dl className="space-y-3">
          ...
          <div className="flex justify-between text-sm">
            ...
            <dd className="text-slate-700">{formatDate(client.created_at)}</dd>
          </div>
        </dl>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="bg-blue-500 text-white rounded-lg px-4 py-2 text-sm font-medium opacity-50 cursor-not-allowed"
          >
            Generate Report
          </button>
        </div>
